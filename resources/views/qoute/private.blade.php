<div class="col-md-12 private">
    ...
    <select name="private_tour" class="form-control alt" required>
        ...
        <option {{ $package == $value ? 'selected' : '' }} value="{{ $key }}">{{ $value }}</option>
        @endforeach
    </select>
</div>
</div>
...
<div class="col-md-12 hours">
    ...
    <input type="number" class="form-control alt"
            name="hours"></div>
</div>
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <input name="pick_up_time" class="form-control alt" id="pick_up_time" type="text" required
