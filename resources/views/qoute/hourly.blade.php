<div class="col-md-12 hours">
    <div class="form-group"><label for="service type">Number of hours </label>
    <input type="number" class="form-control alt" value="{{ $hour }}"
            name="hours"> </div>
</div>
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <input name="pick_up_location" class="form-control alt" value="{{ $pickup }}" id="pick_up_location" type="text"
...
<div class="col-md-6">
    <div class="form-group"><label for="Drop Off Address">Drop Off Adress</label>
        <input class="form-control alt" id="drop_off_location" type="text" value="{{ $dropoff }}" placeholder="Drop Off Address"
