    ...
    <div class="pagetitle">
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Page Update </li>
            </ol>
        </nav>
    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="meta_description" id="meta_description"
                                        value="{{ $item->meta_description }}" class="form-control">
                                </div>
                            </div>
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="meta_keywords" id="meta_keywords"
                                        value="{{ $item->meta_keywords }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control wysiwyg" id='wysiwyg' name="content">{{ $item->content }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="section_1_heading" id="section_1_heading"
                                        value="{{ $item->section_1_heading }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="section_1_subheading" id="section_1_subheading"
                                        value="{{ $item->section_1_subheading }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <img src="{{ asset('assets/images/pagebanner/' . $item->section_1_image) }}" style="height: 100px; width: 100px;">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="input" name="section_1_image_alt_tag" id=""class="form-control"
                                        value="{{ $item->section_1_image_alt_tag }}">
                                </div>
                            </div>

                            <div class="row mb-3 mt-5">
                                <label for="inputText" class="col-sm-2 col-form-label">Section One Book Button Title
                                </label>
                                <div class="col-sm-10">
                                    <input type="text" name="section_1_book_button_title" id="section_1_book_button_title"
                                        value="{{ $item->section_1_book_button_title }}" class="form-control">
                                </div>
                            </div>
                            <div class="row mb-3 mt-5">
                                <label for="inputText" class="col-sm-2 col-form-label">Section One Book Button URL
                                </label>
                                <div class="col-sm-10">
                                    <input type="text" name="section_1_book_button_url" id="section_1_book_button_url"
                                        value="{{ $item->section_1_book_button_url }}" class="form-control">
                                </div>
                            </div>
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="section_1_qoute_button_title"
                                        id="section_1_qoute_button_title" value="{{ $item->section_1_qoute_button_title }}"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="section_1_qoute_button_url"
                                        id="section_1_qoute_button_url" value="{{ $item->section_1_qoute_button_url }}"
                                        class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="section_2_title" id="section_2_title"
                                        value="{{ $item->section_2_title }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control wysiwyg" id='wysiwyg' name="section_2_content">{{ $item->section_2_content }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="section_3_title" id="section_3_title"
                                        value="{{ $item->section_3_title }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="file" name="section_3_image" id="section_3_image"
                                        class="form-control">
                                        <img src="{{ asset('assets/images/page/' . $item->section_3_image) }}" style="height: 100px; width: 100px;">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                <label for="inputText" class="col-sm-2 col-form-label">Image Alt Tag </label>
                                <div class="col-sm-10">
                                    <input type="input" name="section_3_image_alt_tag" id=""class="form-control"
                                        value="{{ $item->section_3_image_alt_tag }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control wysiwyg" id='wysiwyg' name="section_3_content">{{ $item->section_3_content }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="section_4_title" id="section_4_title"
                                        value="{{ $item->section_4_title }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="file" name="section_4_image" id="section_4_image"
                                        class="form-control">
                                        <img src="{{ asset('assets/images/page/' . $item->section_4_image) }}" style="height: 100px; width: 100px;">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                <label for="inputText" class="col-sm-2 col-form-label">Image Alt Tag </label>
                                <div class="col-sm-10">
                                    <input type="input" name="section_4_image_alt_tag" id=""class="form-control"
                                        value="{{ $item->section_4_image_alt_tag }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control wysiwyg" id='wysiwyg' name="section_4_content">{{ $item->section_4_content }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="section_5_title" id="section_5_title"
                                        value="{{ $item->section_5_title }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                <label for="inputText" class="col-sm-2 col-form-label">Image Alt Tag </label>
                                <div class="col-sm-10">
                                    <input type="input" name="section_5_image_alt_tag" id=""class="form-control"
                                        value="{{ $item->section_5_image_alt_tag }}">
                                        <img src="{{ asset('assets/images/page/' . $item->section_5_image) }}" style="height: 100px; width: 100px;">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control wysiwyg" id='wysiwyg' name="section_5_content">{{ $item->section_5_content }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="section_6_title" id="section_6_title"
                                        value="{{ $item->section_6_title }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control wysiwyg" id='wysiwyg' name="section_6_content">{!! $item->section_6_content !!}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="section_7_heading" id="section_7_heading"
                                        value="{{ $item->section_7_heading }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="section_7_subheading" id="section_7_subheading"
                                        value="{{ $item->section_7_subheading }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="file" name="section_7_image" id="section_7_image"
                                        class="form-control">
                                        <img src="{{ asset('assets/images/pagebanner/' . $item->section_7_image) }}" style="height: 100px; width: 100px;">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                <label for="inputText" class="col-sm-2 col-form-label">Image Alt Tag </label>
                                <div class="col-sm-10">
                                    <input type="input" name="section_7_image_alt_tag" id=""class="form-control"
                                        value="{{ $item->section_7_image_alt_tag }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="section_7_book_button_title" id="section_7_book_button_title"
                                        value="{{ $item->section_7_book_button_title }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="section_7_book_button_url" id="section_7_book_button_url"
                                        value="{{ $item->section_7_book_button_url }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="section_7_qoute_button_title"
                                        id="section_7_qoute_button_title" value="{{ $item->section_7_qoute_button_title }}"
                                        class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="section_7_qoute_button_url"
                                        id="section_7_qoute_button_url" value="{{ $item->section_7_qoute_button_url }}"
                                        class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="section_8_1_heading" id="section_8_1_heading"
                                        value="{{ $item->section_8_1_heading }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control wysiwyg" id='wysiwyg' name="section_8_1_text">{!! $item->section_8_1_text !!}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="section_8_2_heading" id="section_8_2_heading"
                                        value="{{ $item->section_8_2_heading }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control wysiwyg" id='wysiwyg' name="section_8_2_text">{!! $item->section_8_2_text !!}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="section_8_3_heading" id="section_8_3_heading"
                                        value="{{ $item->section_8_3_heading }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control wysiwyg" id='wysiwyg' name="section_8_3_text">{!! $item->section_8_3_text !!}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="section_8_4_heading" id="section_8_4_heading"
                                        value="{{ $item->section_8_4_heading }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control wysiwyg" id='wysiwyg' name="section_8_4_text">{!! $item->section_8_4_text !!}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="section_9_heading" id="section_9_heading"
                                        value="{{ $item->section_9_heading }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control wysiwyg" id='wysiwyg' name="section_9_text">{!! $item->section_9_text !!}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control wysiwyg" id='wysiwyg' name="why_choose_us">{!! $item->why_choose_us !!}</textarea>
                                </div>
                            </div>

                            <div class="row mb-3 mt-5">
                                <label for="inputText" class="col-sm-2 col-form-label">Why choose us button Title </label>
                                <div class="col-sm-10">
                                    <input type="text" name="why_choose_button_title" id="why_choose_button_title"
                                        value="{{ $item->why_choose_button_title }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="why_choose_button_url" id="why_choose_button_url"
                                        value="{{ $item->why_choose_button_url }}" class="form-control">
                                </div>
                            </div>
