                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control editor" id='editor' name="content" style="height: 100px"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <label for="inputPassword" class="col-sm-6 col-form-label">SEO Description </label>
                            <div class="col-sm-10">
                                <textarea class="form-control" name="seo_description" style="height: 100px"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
