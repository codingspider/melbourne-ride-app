...
@section('title', 'Customer Review To Driver')
@section('content')
<style>
    .hgt{
      display: flex;
                ...
                <div class="col-12">
                    <div class="card top-selling overflow-auto">
                        ...
                        <div class="col-10 row filter-item">
                            <form class="input" id="search-form" action="" method="GET">
                              <div class="col-2">
                                ...
                                <select class="form-control form-control-sm" data-live-search="true" name="customer_id" onchange="filter()">
                                    <option value="">Select Customer</option>
                                    @foreach($customers as $customer)
                                        <option value="{{ $customer->id }}" {{ ($customer_id == $customer->id) ? 'selected' : null }}>{{ $customer->name }} | {{ $customer->phone }}</option>
                                    @endforeach
                                </select>
                              </div>
                              <div class="col-2">
                        ...
                        <div class="card-body pb-0">
                            {{-- <h5 class="card-title">Customer Review List </h5> --}}
